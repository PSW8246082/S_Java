...
public class Exam_MapColloection {
...
//	---------메인에 넣어줘야 작동함!!-----------------
	...
	public void mapExample2() {
		...
		System.out.println("상품 가격은 " + (String)objMap.get("price")+"원");
...
//		}
		...
		System.out.println("031을 누그면 경기도가 나옵니다 : " + map.get("031"));
		
		
		Scanner sc = new Scanner(System.in);
		System.out.print("지역번호 입력 : ");
		String regionCode = sc.next();
		System.out.println("입력하신 지역번호에 대한 지역 : " + map.get(regionCode));
